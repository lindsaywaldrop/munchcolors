...
The palettes are designed to be used with continuous (quantitative) data with single or diverging series or qualitative data. Click on each palette name for the painting and the palette together.
